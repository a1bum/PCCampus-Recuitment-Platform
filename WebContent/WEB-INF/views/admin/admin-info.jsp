		...
		<form class="layui-form">
			<div class="layui-form-item">
				<label for="username" class="layui-form-label"> <span
					class="x-red">*</span>登录账号
				</label>
				<div class="layui-input-inline">
					<input type="text" id="username" name="username" required=""
						lay-verify="required" autocomplete="off" value="admin"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				<label for="phone" class="layui-form-label"> <span
					class="x-red">*</span>用户名称
				</label>
				<div class="layui-input-inline">
					<input type="text" value="18925139194" id="phone" name="phone"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" value="113664000@qq.com" id="L_email"
						name="email" required="" lay-verify="email" autocomplete="off"
						class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red">*</span>找回密码或通知用
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="checkbox" name="like1[write]" lay-skin="primary"
						title="超级管理员（分配帐户）" checked=""> <input type="checkbox"
						name="like1[read]" lay-skin="primary" title="管理员">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<button class="layui-btn layui-btn-danger" lay-filter="add" lay-submit="">
					修改</button>
					<button class="layui-btn" lay-filter="submit" lay-submit="" hidden="${isModified}">
					提交</button>
			</div>
		</form>
	</div>
